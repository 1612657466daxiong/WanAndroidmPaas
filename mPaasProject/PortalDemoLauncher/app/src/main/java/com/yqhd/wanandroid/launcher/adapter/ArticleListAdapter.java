...
public class ArticleListAdapter extends BaseQuickAdapter<FeedArticleData,FeedArticleViewHolder>{
    ...
    @Override
    protected void convert(FeedArticleViewHolder helper, FeedArticleData article) {
    ...
    private void setTag(FeedArticleViewHolder helper, FeedArticleData article) {
    ...
    private void setRedTag(FeedArticleViewHolder helper, @StringRes int tagName) {
